...
DB.prototype.getObjectSQL = function(jsh, sqlext, moduleName, module, sql, dbconfig, options){
  ...
  if(sql=='init'){
    if(_this.sql.object.initSchema) addSQL(null, _this.sql.object.initSchema(jsh, module, dbconfig));
  }
  ...
  if(sql=='drop'){
    if(_this.sql.object.dropSchema) addSQL(null, _this.sql.object.dropSchema(jsh, module));
  }
